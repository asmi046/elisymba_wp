	...
	<div class="product-content page-content-arial">
        ...
        <div class="product-main-info clearfix">
            <div class="fl">
                <div class="product-image">
					 <div class="jcarousel-wrapper">
						<?php 
						 	//echo $_SERVER['DOCUMENT_ROOT']."/galery/".get_post_meta(get_the_ID(), "SKU", true).".2.jpg";
						 ?>
				...
				<?php if (empty($GLOBALS['postcode']) ) {?>
					<span class = "viev_map">Показать пункты выдачи</span>
					<?php 
						$pvs = new SimpleXMLElement(file_get_contents("https://integration.cdek.ru/pvzlist/v1/xml?citypostcode=".$GLOBALS['postcode']));						
					...
					<script>										
						...
						var dummyMap, myPlacemark;
								var centerContactLat = '<?php echo $pvs->Pvz[0]["coordY"]; ?>';
						var centerContactLng = '<?php echo $pvs->Pvz[0]["coordX"]; ?>';
						...
						function init() {
							dummyMap = new ymaps.Map('map_pvt', {center: [parseFloat(centerContactLat), parseFloat(centerContactLng)], zoom: 10});
									...
									<?php 
										...
										foreach ($pvs->Pvz as $elem) {
											?>
												myPlacemark = new ymaps.Placemark([<?php echo $elem["coordY"]; ?>, <?php echo $elem["coordX"]; ?>], {
													hintContent: "<?php echo $elem["Address"]; ?>",
													balloonContent: "<?php echo $elem["Address"]; ?>"
												}, {
            ...
            <div class = "podWidget">
				...
				<?php
					if (($pricr_cur > 7500)||(get_the_ID() == 10330)):
				?>
					<div class = "posWline">
						<div class = "imWriper">
