	<footer class="site-footer">
        <div class="wrapper clearfix">
            ...
            <div class="footer-menu">
                <!--
				<ul>
                    <li><a href="/modulnye-kartiny/#tovar">Каталог
                            картин</a></li>
                    <li><a href="/o-nas.html#tovar">О нас</a></li>
                    <li><a href="/dostavka.html#tovar">Доставка</a></li>
                    <li><a href="/garantiya.html#tovar">Гарантия</a></li>
                    <li><a href="/kontaktyi.html#tovar">Контакты</a></li>
                    <li><a href="/kak-sdelat-zakaz.html#tovar">Как сделать
                            заказ</a></li>
                </ul>
				-->
            ...
            <div class="footer-pay">
                ...
                <ul>
                    <li><a href="#"><img src="<?php  echo get_template_directory_uri(); ?>/img/visa.png" alt="Картинка"></a></li>
                    <li><a href="#"><img src="<?php  echo get_template_directory_uri(); ?>/img/mastercard.png" alt="Картинка"></a>
                    </li>
                    <li><a href="#"><img src="<?php  echo get_template_directory_uri(); ?>/img/webmoney.png" alt="Картинка"></a></li>
                    <li><a href="#"><img src="<?php  echo get_template_directory_uri(); ?>/img/yandexmoney.png" alt="Картинка"></a>
                    </li>
                </ul>
...
<div class="clearfix desc-wrapper">
        ...
        <div class="description">
			...
			<p class="bonus">+ Кубики “собери картинку”!</p>
			<p class="bonus bonus2">+ Мини бизиборд!</p>
			
			<img  src = '<?php bloginfo("template_url"); ?>/img/opdarok-bascet-r.png' />
...
<label class="control-label" for="order-client_tel">Номер телефона:</label>
<input type="text" id="order-client_tel" class="form-control" name="Order[client_tel]" data-plugin-inputmask="inputmask_96e76a5f">
<div class="hint-block">чтобы мы смогли с Вами связаться и уточнить детали заказа</div>
<div class="help-block"></div>
</div>        

<!--
<div class="form-group field-order-client_comment">
	<label class="control-label" for="order-client_comment">Комментарии к заказу</label>
	<textarea id="order-client_comment" class="form-control" name="Order[client_comment]"></textarea>

<div class="help-block"></div>
</div>        
-->

<!-- <button onclick="yaCounter48236084.reachGoal('zakaz');" type="submit" class="btn btn-pink" style="margin: 0 auto">Заказать</button>-->    
<span onclick="yaCounter48236084.reachGoal('zakaz');" class="btn btn-pink oneClikZal" style="margin: 0 auto">Заказать</span>

<!--
<span class = "prodPok"  data-postid = "">Продолжить покупки</span>
-->
...
<script type="text/javascript">
	...
	jQuery("#bascetphone").inputmask(inputmask_96e76a5f);
