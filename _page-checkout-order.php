			...
			<section id = "scrollToH" class="page-content page-bascet-checaut">
					...
					<form action="" class="checkout-form" method="post" id="checkout-form">
						<div class="checkout-form__block">
							...
							<input type="text" required name="name" id="checkout-form__name" placeholder="Имя *">
							<div class="checkout-form__block-checked"></div>
						</div>
						<div class="checkout-form__block">
							<label for="checkout-form__phone">Ваш Телефон <span>*</span></label>
							<input type="tel" class = "mascedphoneclass" required name="phone" placeholder="Телефон *" id="checkout-form__phone">
							<div class="checkout-form__block-checked"></div>
						</div>
						<div class="checkout-form__block">
					...
					?>
						...
						<div class="checkout-form__block-submit">
							...
							<div class="checkout-form__block-submit-btn oformlenieZak" onclick="yaCounter48236084.reachGoal('oform_zakaz_konec');" >Оформить заказ</div>
						</div>
					</form>
			</section>
        </div>
