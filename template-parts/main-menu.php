          ...
          <ul class="menu ul-clean d-flex">
            ...
            <ul class="sub-menu">
              <li><a href="<?php echo get_category_link('3');?>">
                ...
                <span>Смотреть все бизиборды</span>
               </a>
              </li>
            ...
            <ul class="sub-menu">
              ...
              <li><a href="<?php echo get_category_link('76');?>">
                <img src="<?php echo get_template_directory_uri();?>/img/category/min-PZL14.2.jpg" alt=""> 
                <span>Пазлы</span>
               </a>
              </li>
              <li><a href="<?php echo get_category_link('55');?>">
                <img src="<?php echo get_template_directory_uri();?>/img/category/min-Pir02.2.jpg" alt=""> 
                <span>Пирамиды</span>
               </a>
              </li>
              <li><a href="<?php echo get_category_link('52');?>">
                <img src="<?php echo get_template_directory_uri();?>/img/category/min-Sor04.2.jpg" alt=""> 
                <span>Сортер</span>
               </a>
              </li>
              <li><a href="<?php echo get_category_link('53');?>">
            ...
            <li><a href="#">Музыкальные игрушки</a>
            <ul class="sub-menu">
              ...
              <li><a href="<?php echo get_category_link('27');?>">
                <img src="<?php echo get_template_directory_uri();?>/img/category/MI26.1.jpg" alt=""> 
            ...
            <li><a href="#">Коврики и пазлы</a>
            <ul class="sub-menu">
              <li><a href="<?php echo get_category_link('58');?>">
                <img src="<?php echo get_template_directory_uri();?>/img/category/MI26.1.jpg" alt=""> 
                <span>Все товары</span>
               </a>
              </li>
