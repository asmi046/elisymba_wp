            ...
            <div class="product-desc">
                ...
                <div class = "pricingCount" style="font-size: 16px; text-transform: none; color: #919191; margin-top: 10px;     font-family: sans-serif">
                    Данный товар купили <b><?php echo get_post_meta(get_the_ID(), "order_count", true);?></b> раз(а).
						...
						<?
							$sale_delivery_city = array("Москва","Санкт-Петербург", "Волгоград", "Белгород","Владимир", "Воронеж", "Казань", "Калуга", "Ставрополь", "Тверь", "Тула", "Ярославль", "Краснодар", "Нижний Новгород", "Ростов-на-Дону", "Самара", "Пенза", "Орёл", "Зеленоград", "Зеленодольск", "Иваново"); 
